...
public class Keys {
    ...
    public static final UniqueKey<PosterFavoriteRecord> KEY_POSTER_FAVORITE_PRIMARY = Internal.createUniqueKey(PosterFavorite.POSTER_FAVORITE, DSL.name("KEY_poster_favorite_PRIMARY"), new TableField[] { PosterFavorite.POSTER_FAVORITE.POSTER_ID, PosterFavorite.POSTER_FAVORITE.ARTICLE_ID }, true);
    ...
    public static final ForeignKey<PosterFavoriteRecord, PosterRecord> POSTER_FAVORITE_FK = Internal.createForeignKey(PosterFavorite.POSTER_FAVORITE, DSL.name("poster_favorite_FK"), new TableField[] { PosterFavorite.POSTER_FAVORITE.POSTER_ID }, Keys.KEY_POSTER_PRIMARY, new TableField[] { Poster.POSTER.ID }, true);
    public static final ForeignKey<PosterFavoriteRecord, ArticleRecord> POSTER_FAVORITE_FK_1 = Internal.createForeignKey(PosterFavorite.POSTER_FAVORITE, DSL.name("poster_favorite_FK_1"), new TableField[] { PosterFavorite.POSTER_FAVORITE.ARTICLE_ID }, Keys.KEY_ARTICLE_PRIMARY, new TableField[] { Article.ARTICLE.ID }, true);
