 ...
 */
package example.social.domain.user.infrastructure.data.schema.tables;


import example.social.domain.user.infrastructure.data.schema.Keys;
import example.social.domain.user.infrastructure.data.schema.Test;
...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> ACCOUNT = createField(DSL.name("account"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>test.user.created_at</code>.
     */
    public final TableField<UserRecord, Long> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.BIGINT.nullable(false), this, "");
